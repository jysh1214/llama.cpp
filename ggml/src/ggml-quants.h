...
GGML_API void quantize_row_q_fp8_e4m3fn_ref(const float * GGML_RESTRICT x, block_q_fp8_e4m3fn * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_q_fp8_e4m3fn(const block_q_fp8_e4m3fn * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_q_fp8_e4m3fn(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
